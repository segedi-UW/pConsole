...
nnoremap ,sw :execute 'leftabove split ' . bufname("#") 
...
inoremap  <Nop>
inoremap jk 
iabbr @web@ https://www.ajseg.com
iabbr @wemail@ segedi@wisc.edu
iabbr @pemail@ aj.segedi@gmail.com
iabbr @name@ Anthony Segedi
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set laststatus=2
set ruler
set runtimepath=~/.vim,~/.vim/pack/gitPacks/start/nerdtree,~/.vim/pack/gitPacks/start/nerdcommenter,~/.vim/pack/gitPacks/start/lightline,~/.vim/pack/gitPacks/start/auto-pairs,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=10
set shiftwidth=4
set showcmd
set showmatch
...
inoremap <buffer> <silent> { =AutoPairsInsert('{')
inoremap <buffer> <silent> } =AutoPairsInsert('}')
iabbr <buffer> psvm public static void main(String[] args) {return;}<Up><Up>	
iabbr <buffer> serrf System.err.printf("");
iabbr <buffer> serr System.err.println("");
iabbr <buffer> soutf System.out.printf("");
iabbr <buffer> sout System.out.println("");
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 103 - ((30 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((32 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
badd +1 Main.java
badd +1 Cons.java
badd +3 Callable.java
badd +1 LoadHandler.java
badd +10 Loader.java
badd +58 ProgCall.java
badd +49 progs/crypt/Decrypt.java
badd +30 progs/crypt/encrypt.java
badd +10 Prog.java
badd +1 ProgLoader.java
badd +1 ManLoader.java
badd +1 help.txt
badd +1 progs/load.prog
badd +1 man.txt
badd +5 progs/list.prog
badd +1 Basic.java
badd +1 load.prog
badd +3 ProgLoader
badd +1 ManLoader
...
badd +1 Load.java
badd +1 Prog
badd +36 ManCall.java
badd +1 progs/Load.java
badd +22 man.man
badd +15 help.man
badd +37 progs/List.java
badd +4 ../old_pConsole/progs/list.prog
badd +30 ../old_pConsole/Prog.java
badd +258 ../old_pConsole/ProgCall.java
badd +2 progs/Load.man
badd +1 Load.man
badd +1 progs/List.man
badd +1 ext/LoadAll.java
badd +7 progs/ext/LoadAll.java
badd +3 progs/ext/LoadAll.man
badd +1 progs/ext/Optimizer.java
badd +24 progs/crypt/Encrypt.java
badd +0 InputReader
badd +11 InputReader.java
badd +7 progs/util/List.java
badd +5 progs/util/LoadAll.java
badd +6 ANSISplicer.java
badd +8 intro.rd
badd +3 progs/util/ReadLog.java
badd +10 progs/util/Logs.java
badd +2 progs/crypt/crypt.log
badd +23 progs/crypt/Decrypt.class
badd +1 progs/util/LoadAll.
badd +0 progs/util/LoadAll.man
